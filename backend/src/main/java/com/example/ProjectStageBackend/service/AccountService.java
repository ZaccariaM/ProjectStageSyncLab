...
public class AccountService {
    ...
    private AccountService(AccountRepository accountRepository, JwtService jwtService, AuthenticationManager authenticationManager) {
    ...
    public String verify(AccountModel acc) {
        ...
        if (authentication.isAuthenticated()) {
            System.out.println("verify");   //for debugging
